            ...
            <div class="container-fluid" align="center">
                <table>
                    ...
                    <th align="center">Amortização</th>
                        ...
                        <% for(int i=1; i<=mes;i++){%>
                            <%if(i == 1){
                                parc = vl * ((juro / 100) / (1 - Math.pow(((juro / 100) +1), -mes)));
                                amortiz = parc - j;
                                vlt = vl - amortiz;
                            }else{
                        ...
                        <tr>
                            ...
                            <td align="center"><%= decimal.format(vlt)%> </td>
                            <td align="center">R$<%= decimal.format(parc) %></td>
                            <td align="center">R$<%= decimal.format(j) %></td>
                            <td align="center">R$<%= decimal.format(amortiz) %></td>
