...
public class SubtractionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Subtração - Servlets</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                double result = n1-n2;
                out.println("<h3>A subtração de "+n1+" e "+n2+" é igual a <b>"+result+"<b/></h3>");
            }catch(Exception ex){
                out.println("<h3>Erro ao tentar ler os parametros n1 e n2</h3>");
            }
            out.println("</body>");
            out.println("</html>");
        }
